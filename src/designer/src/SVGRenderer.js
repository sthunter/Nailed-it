...
export const styles = {
  ...
  grid: {
    backgroundImage: 'url(http://datacouch.pw/wp-content/uploads/2016/04/parquet-flooring-basketball-court-floor-charming-with-texture-jpg-gym-basketball-parquet-flooring-basketball.jpg)',
    //backgroundSize: "auto"
    /*
